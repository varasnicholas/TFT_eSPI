// Blue pill can be overclocked:
// Change C:\Users\xxxxxx\AppData\Local\Arduino15\packages\STM32\hardware\stm32\1.7.0\variants\PILL_F103XX\variants.cpp
// Line 118 to:
/*
  //RCC_OscInitStruct.PLL.PLLMUL = RCC_PLL_MUL9; // 72MHz
  RCC_OscInitStruct.PLL.PLLMUL = RCC_PLL_MUL16; // 128 MHz
*/
// Set Blue pill SPI clock rate to #define SPI_FREQUENCY  32000000 (it will actually use 64MHz
...
#define SPI_FREQUENCY  32000000   // 27MHz SPI clock
//#define SPI_FREQUENCY  27000000   // 27MHz SPI clock
//#define SPI_FREQUENCY  48000000   // 55MHz is over-clocking ILI9341 but seems to work reliably!
...
// This has no effect, transactions are always needed for STM32 and are automatically enabled
